...
.dev/scala213.classpath:
	mkdir -p .dev && cs fetch -p org.scala-lang:scala-compiler:2.13.15 > .dev/scala213.classpath

.dev/scala3bridge.jar:
	mkdir -p .dev && cd scala-3-bridge && scala-cli package . --library -f -o ../.dev/scala3bridge.jar

.dev/scala212bridge.jar:
	mkdir -p .dev && cd scala-212-bridge && scala-cli package . --library -f -o ../.dev/scala212bridge.jar

.dev/scala213bridge.jar:
	mkdir -p .dev && cd scala-213-bridge && scala-cli package . --library -f -o ../.dev/scala213bridge.jar

.dev/scala212.classpath:
	mkdir -p .dev && cs fetch -p org.scala-lang:scala-compiler:2.12.20 > .dev/scala212.classpath

.dev/scala3.classpath:
	mkdir -p .dev && cs fetch -p org.scala-lang:scala3-compiler_3:3.3.4 > .dev/scala3.classpath
...
run-backend: .dev/scala213.classpath .dev/scala212.classpath .dev/scala3.classpath .dev/scala3bridge.jar .dev/scala212bridge.jar .dev/scala213bridge.jar
	cd backend && \
